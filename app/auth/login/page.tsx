      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="shadow-xl border-slate-200 bg-white/90 backdrop-blur-sm">
          <CardHeader className="space-y-2 pb-6">
            ...
            <CardDescription className="text-slate-600">Sign in to access your healthcare dashboard</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="text-center text-sm text-slate-600 pt-2">
                ...
                <Link href="/auth/sign-up" className="text-slate-800 hover:underline font-semibold">
                  Create Account
                </Link>
              </div>
            </form>
